...
//		System.out.println(Arrays.toString(cast(120.15434, 30.27491)));
	...
	// 1.FileMain.main   下载所有文件
	// 2.Test1.test2  根据某个目录下的url文件下载瓦片
	@Test
	public void test2() {
//		String path=ConfigUtil.get("downloadDir")+"/12";
//		String path=ConfigUtil.get("downloadDir")+"/13";
//		String path=ConfigUtil.get("downloadDir")+"/14";
//		String path=ConfigUtil.get("downloadDir")+"/15";
		String path=ConfigUtil.get("downloadDir")+"/16";
